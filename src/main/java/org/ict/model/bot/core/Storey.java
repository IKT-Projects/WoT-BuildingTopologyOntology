...
import org.ict.model.bot.core.iface.StoreyIf;
...
public class Storey extends Zone implements StoreyIf {
  private static final transient List<URI> defaultType = new ArrayList<>();
  static {
    defaultType.add(URI.create("https://w3id.org/bot#Storey"));
  }
  @SerializedName("schema:floorLevel")
  private String floorLevel;

  public Storey() {
    super(null, defaultType, null, null, null, null, null, null, null, null, null, null, null, null, null,
        null);
  }

  @Builder
  public Storey(URI id, List<URI> atType, String name, String floorLevel, List<Zone> containsZone,
  ...
  public void setAtTypeRDF(List<URI> types) {
    ...
    if (filtered.isEmpty()) {
      filtered.add(URI.create("https://w3id.org/bot#Storey"));
      setAtType(filtered);
    } else {
      setAtType(filtered);
    }
